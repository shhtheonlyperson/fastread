...
// fast and CI-safe. Default path is the local Readmoo export at
// ~/proj/readmoo/exports/all; override with FASTREAD_EPUB_CORPUS_DIR.
...
final class EpubCorpusTests: XCTestCase {
    ...
    private static let corpusDir: String = {
        ...
        return (NSHomeDirectory() as NSString).appendingPathComponent("proj/readmoo/exports/all")
    }()
