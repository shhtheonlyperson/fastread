// End-to-end EPUB ingest test against a real local EPUB export.
//
...
const DEFAULT_EPUB =
  ...
  join(homedir(), "proj", "local-epub", "exports", "all", "local-test-book.epub");
...
if (!epubAvailable) {
  ...
  test("epub-e2e: local-test-book imports as a multi-chapter Document", () => {
