...
- Latest live internal-testing release observed through the Play Developer API: `0.2.3` (versionCode 10), `completed`, uploaded May 16, 2026 PDT.
- Current local release candidate: `0.2.3` (versionCode 10), built and uploaded to Play internal testing on May 16, 2026 PDT.
...
- May 16, 2026 Claude design-system release: Android `0.2.3` / versionCode 10 was built from commit `b513edb` and uploaded through `fastlane internal`; live Play track readback returned internal release `0.2.3`, versionCode `10`, status `completed`.
