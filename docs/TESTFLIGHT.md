...
- Latest successfully uploaded build: `30`
- Latest delivery/build UUID: `82b3cd9c-ef9f-4727-921b-3977ec36b5ca` — build 30 picks up the persisted-tokens path (`RSVPEngine.version = 1`) so the reader stops re-tokenizing on every launch.
